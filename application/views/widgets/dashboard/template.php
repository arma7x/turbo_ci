            ...
            <div id="dashboard-menu" class="col col-12 col-lg-2 px-0 fixed-top dashboard-menu shadow">
                <div id="navCollapsed" class="collapse navbar-collapse-dashboard shadow">
                    ...
                    <div id="accordionDashboard" class="accordion bg-light">
                      ...
                      <div class="dropdown-item py-2" data-toggle="collapse" data-target="#collapseMU" aria-expanded="false" aria-controls="collapseMU">
                        <div id="headingMU">
                            <i class="material-icons">&#xe7ef;</i> <?php echo lang('H_MANAGE_USERS');?>
                        </div>
                        <div id="collapseMU" class="<?php echo $this->uri->segment(2) == 'manage_user' ? '' : 'collapse'?>" aria-labelledby="headingMU" data-parent="#accordionDashboard">
                          <div>
                              <div class="dropdown-divider"></div>
                              <ul class="nav nav-pills flex-column" style="overflow:hidden">
                                  <li class="nav-item">
